...
def create_cover_pages(story_theme, author_name, main_character_image):
    ...
    d.text((50, 100), f"{story_theme}", fill=(0, 0, 0))
    d.text((50, 200), f"Author: {author_name}", fill=(0, 0, 0))
